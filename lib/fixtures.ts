...
export const fixtureRoutes: Route[] = [
  {
    ...
    dayNarrative: {
      scenes: [
        ...
        { text: "洗漱的时候还在想昨天没回完的那条消息，决定到了公司再说。" },
        { text: "出门前往包里塞了一本书，是上周读到一半没读完的那本。" },
        { text: "地铁里人不多，靠着门把今天的三件事在脑子里排了个序。" },
        { text: "上午的会先开完，处理完手头的事，留出一小时做跨部门的小型研究，同事路过时聊了两句。" },
        { text: "中午和熟悉的同事拼桌吃饭，聊的不是工作，是楼下新开的面馆。" },
        { text: "下午有个环节卡住了，喝了口水，把问题拆小，找人问了一句就过去了。" },
        { text: "下班前把今天的笔记翻了一遍，发现有一行字被自己划了两道线。" },
        { text: "窗外暗下来，路灯一盏接一盏亮了，走在回去的路上，风有点凉。" },
        { text: "到家煮了碗面，边看电视边吃，什么也没想。" },
        { text: "睡前把那本没读完的书又翻了几页，恰好读到一句让人停下来的话。" },
  ...
  },
  {
    ...
    dayNarrative: {
      scenes: [
        ...
        { text: "早高峰的电梯里挤得动不了，闻到旁边人手里的豆浆味。" },
        { text: "上午把本职的事一件件清掉，清单上的勾越画越多。" },
        { text: "午休没睡，翻了几页新领域入门的资料，划了两条看不懂的术语。" },
        { text: "下午的效率一般，索性提前半小时收尾，把状态留给晚上。" },
        { text: "下班后赶去参加一个邻近领域的线下活动，到的时候人已经不少。" },
        { text: "听别人讲了一个多小时，记了三条笔记，有一条打了个问号。" },
        { text: "和坐在旁边的人聊了几句，对方也在从别的方向转过来，说着说着发现有不少重叠。" },
        { text: "回来路上买了一份宵夜，边走边吃，路灯把影子拉得很长。" },
        { text: "在楼下站了一会儿，把今晚听到的那句话又想了想。" },
  ...
  },
  {
    ...
    dayNarrative: {
      scenes: [
        ...
        { text: "慢悠悠做了顿早饭，煎蛋的边缘有点焦，但味道正好。" },
        { text: "上午去了一趟图书馆，翻了几本不相关的书，在其中一本里发现了一个有意思的线索。" },
        { text: "在馆里靠窗的位置坐到中午，把那个线索记进了本子。" },
        { text: "下午做了两小时兼职，剩下的时间沿着河边走了一段，没有特别想什么。" },
        { text: "路过一家小店买了一瓶水，老板在听收音机，新闻里在说今天气温比往年低了两度。" },
        { text: "约了一个做这行的人视频聊了四十分钟，对方说的话一半兴奋一半泼冷水。" },
        { text: "挂了电话在本子上写了一页：哪些是真的，哪些只是听上去好。" },
        { text: "天黑得很快，第一颗星星已经出来了，站在路口看了一会儿才往回走。" },
        { text: "晚饭随便对付了，把明天要约的人名单又添了一个。" },
        { text: "躺下前把窗帘留了条缝，想着明早光会从哪里进来。" },
      ],
    },
