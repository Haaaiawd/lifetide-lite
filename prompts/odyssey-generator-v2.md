...
1. 用从清晨醒来到入睡的 10–16 个片段呈现一天。每个片段只写一句话、一个瞬间：一次醒来、一段路、一件手头的事、一句对话、一次走神。不写段落，不概括——让读者自己在句子之间慢慢走完这一天。
...
- `title`：这种生活的代称——给"一种人"起的名字，两到六个字为宜，如「深耕者」「拾光人」「守夜人」。不是职业名、岗位名或路线编号，人生不由工作头衔定义；
- `title_full`：这个称呼的完整版——带修饰与气息的完整称谓，如「醉意朦胧的清醒者」「在秩序里偷闲的拾光人」。它会在一天的场景之后作为落款出现，要承接那一天的质感，像给过这种日子的人轻轻盖了个章；
- 核心生活体验；
...
- `title` 不得直接使用职业名或岗位名（如「产品经理」「自由撰稿人」「副业探索者」不算代称）；职业可以是内容的一部分，但名字要指向一种生活、一种人；
...
保留分析者的清醒：写吸引力，也写日常摩擦；允许某条路线有吸引力但暂时未知。不写命中注定、电影式成功、创业套话或励志结尾。意蕴深长的收束靠安静的画面，不靠拔高。
