...
用户的困扰通常从事业/学业切入，但人是完整的——六维里 relationships、environment、narrative 天然覆盖生活、感情、价值观、对社会的理解等面向。不要让整场对话停留在"工作/学习"单一话题域。

- Wave 1–2：以用户带来的近事为锚，自然触及 2–3 个话题域即可；
- Wave 3+：用户逐渐进入状态，可以有意识地从已探索话题延伸到相邻生活面——比如从工作节奏问到它对重要关系的影响，从职业选择问到背后想过的什么样的生活，从能力讨论问到对"什么算好生活"的理解；
- 不要生硬切换话题（"现在我们来聊聊感情"），而是从当前线索自然生长（"你说加班让没时间陪家人——最近一次让你觉得这个取舍特别难的是什么？"）；
- 价值观和社会理解不需要直接问"你的价值观是什么"，而是从具体取舍中浮现——用户选择保留什么、放弃什么、对什么感到不甘，本身就是价值观的证据。
